  ...
  return (
    <aside className="hidden md:flex w-52 shrink-0 flex-col border-r border-border bg-surface/40 h-full overflow-hidden">
      <div className="px-3 pt-3 pb-2">
        {isLoggedIn ? (
          <QuickCreateTrigger className="flex w-full items-center justify-center gap-1.5 rounded-md bg-primary px-2 h-8 text-xs font-medium text-primary-foreground transition-colors hover:bg-primary/90" />
        ) : (
          <Link
            href="/issues/new"
